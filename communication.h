...
#define msg_pad_len 2
#define msg_hdr_len 2
#define msg_crc_len 2
#define msg_pad_data 0xFF
...
PROGMEM const static uint16_t crc16tab[256] = {
...
private:
	...
	enum pointer_pose { Padd_search, header_read, msg_read, crc_read, done_reading };
...
public:
	...
	bool push_byte(uint8_t data, uint8_t* (frame_data), size_t &payload_len_para);
...
public:
	...
	enum msg_type_tx { heart_beat, settings_tx, probe, acknowledgement, msg_tx,rx_values };
	enum msg_type_rx { test_plan, command, update_ref, rx_settings };
